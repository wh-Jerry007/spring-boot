  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/dyfzgl/devManage/add",
          edit: "/dyfzgl/devManage/edit",
          queryById: "/dyfzgl/devManage/queryById",
          check: "/dyfzgl/devManage/check"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','sex','nation','birthday','eduHostory','partyName','partyDate','partyTel','partyType'))
        })
      },
      check (record) {
        this.form.resetFields();
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','sex','nation','birthday','eduHostory','partyName','partyDate','partyTel','partyType'))
      },
    }
  }
</script>