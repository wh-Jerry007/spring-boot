        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="组织名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['partyName']" placeholder="请输入组织名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="申请入党日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择申请入党日期" v-decorator="['partyDate']" :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="成为积极分子日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择成为积极分子日期" v-decorator="['partyJjfzDate']" :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/jjfz/dyfzglJjfz/add",
          edit: "/jjfz/dyfzglJjfz/edit",
          queryById: "/jjfz/dyfzglJjfz/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','sex','nation','birthday','eduHostory','partyName','partyDate','partyJjfzDate','partyTel','partyType'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','sex','nation','birthday','eduHostory','partyName','partyDate','partyJjfzDate','partyTel','partyType'))
      },
    }
  }
</script>